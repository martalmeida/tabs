...
var Config = {
    ...
    // API
    velocityGridLocationsURL: '/tabs/data/thredds/velocity/grid',
    velocityFrameURL: '/tabs/data/thredds/velocity/step/',
    saltFrameURL: '/tabs/data/thredds/salt/step/',
    domainURL: '/tabs/data/prefetched/domain',
    timestampURL: '/tabs/data/thredds/timestamps',
