...
@app.route('/tabs/prefetched/domain')
def domain():
...
@app.route('/tabs/thredds/timestamps')
...
@app.route('/tabs/thredds/velocity/grid')
def thredds_grid():
...
@app.route('/tabs/prefetched/velocity/grid')
def static_grid():
    """ Return the grid points for the velocity frames. """
...
@app.route('/tabs/thredds/velocity/step/<int:time_step>')
...
@app.route('/tabs/prefetched/velocity/step/<int:time_step>')
...
@app.route('/tabs/thredds/salt/step/<int:time_step>')
